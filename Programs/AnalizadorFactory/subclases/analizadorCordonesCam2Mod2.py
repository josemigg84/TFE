...
class AnalizadorCordonesCam2Mod2(AnalizadorCordonesBase):
    ...
    def localizar(self):
        ...
        self._resPos2 = self._posicion(roi2, pos_ini2, patron2, suavizar_kernel=7)
    ...
    def _buscar_angulo(self, roi1, roi2, roi_x1, roi_y1, roi_x2, roi_y2, roi_w, roi_h, umbral_res):
        return self._buscar_angulo_horizontal(roi1, roi2, roi_x1, roi_y1, roi_x2, roi_y2, roi_w, roi_h, umbral_res)
