...
2. **Utilizar algún gestor de bases de datos**, para este proyecto se ha utilizado **DataGrip de JetBrains**, pero se puede utilizar cualquier otro válido para **MySQL**
